  ...
  return (
    <section className="panel help">
      ...
      <p className="help__note">
        🎹
        ノートの音高は素材の基準ピッチからの差分で再生速度を変えて発音します。再生は3次エルミート補間で高品質に。抑揚（ベロシティ＋エクスプレッション(CC11)/ボリューム(CC7)）はトラックごとに反映のオン・オフと深さを調整でき、ダイナミックピッチ（グライド・ビブラート）は素材ごとにオフにできます。ロングトーンはループ範囲で持続し、フィルターはアンプEG連動スイープと
        LFO ワブルで時間変化させられます。
      </p>
    </section>
  );
